...
export default function CardWithBgImg({text,title,description,slug,index,category,author,date,customWidth,customBmImg}) {
  ...
  return (
    ...
    <div style={{backgroundImage: `url('/images/ball.jpg')`}} className=' lg:max-w-7xl   bg-cover bg-repeat bg-center  lg:h-96 flex  flex-col items-start justify-end  gap-2 '>
         <Socials show={show}/>
