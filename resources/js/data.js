export const  menuLinks =[
    ...
    {id:5,href:'/category/podosfairo',styleLink:'text-2xl ml-2 text-white  lg:text-xs lg:text-blue-700 lg:hover:text-blue-900  xl:text-base',label:'ΠΟΔΟΣΦΑΙΡΟ'},
    {id:6,href:'/category/basket',styleLink:'text-2xl ml-2 text-white  lg:text-xs lg:text-blue-700 lg:hover:text-blue-900  xl:text-base',label:'ΜΠΑΣΚΕΤ'},
...
export const iframeLinks = [
    {id:1,url:'https://www.youtube.com/embed/KL9BHED4OJY'},
